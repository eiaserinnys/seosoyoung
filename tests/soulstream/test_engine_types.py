...
class TestRoleConfig:
    ...
    def test_default_creation(self):
        """기본값으로 생성"""
        from seosoyoung.slackbot.soulstream.engine_types import RoleConfig
...
class TestCallbackTypes:
    ...
    def test_intervention_callback_type_exists(self):
        ...
        from seosoyoung.slackbot.soulstream.engine_types import InterventionCallback
...
class TestEngineEventType:
    ...
    def test_all_members_exist(self):
        """4가지 이벤트 타입이 모두 존재"""
        from seosoyoung.slackbot.soulstream.engine_types import EngineEventType
...
class TestEngineEvent:
    ...
    def test_basic_creation(self):
        ...
        from seosoyoung.slackbot.soulstream.engine_types import EngineEvent, EngineEventType
    ...
    def test_fields(self):
        """dataclass 필드 목록 확인"""
        from seosoyoung.slackbot.soulstream.engine_types import EngineEvent
...
class TestEventCallback:
    ...
    def test_event_callback_exists(self):
        ...
        from seosoyoung.slackbot.soulstream.engine_types import EventCallback
        assert EventCallback is not None

    def test_no_conflict_with_existing_callbacks(self):
        """기존 콜백 타입들과 함께 import 가능"""
        from seosoyoung.slackbot.soulstream.engine_types import (
            CompactCallback,
            EventCallback,
