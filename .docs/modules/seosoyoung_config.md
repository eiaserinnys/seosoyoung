...
- `get_pre_routing_enabled()` (줄 115): 사전 라우팅 활성화 여부
- `get_pre_routing_model()` (줄 120): 사전 라우팅에 사용할 모델
- `get_pre_routing_threshold()` (줄 125): 사전 라우팅 적합도 임계값 (1-10)
- `get_pre_routing_timeout()` (줄 130): 사전 라우팅 타임아웃 (초)
