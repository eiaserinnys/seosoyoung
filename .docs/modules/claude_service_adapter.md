...
- `async execute(self, prompt, request_id, resume_session_id, on_progress, on_compact, on_debug, on_session, on_credential_alert)` (줄 38): Claude Code를 soul 서버에서 실행하고 ClaudeResult로 반환
