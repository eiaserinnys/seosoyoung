...
> 경로: `seosoyoung/slackbot/plugins/memory/observer.py`
...
- `seosoyoung.slackbot.plugins.memory.prompts.build_observer_system_prompt`
- `seosoyoung.slackbot.plugins.memory.prompts.build_observer_user_prompt`
