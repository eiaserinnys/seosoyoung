# channel_observer/pipeline.py

> 경로: `seosoyoung/slackbot/plugins/channel_observer/pipeline.py`
...
### `async run_channel_pipeline(store, observer, channel_id, slack_client, cooldown, threshold_a, threshold_b, compressor, digest_max_tokens, digest_target_tokens, debug_channel, intervention_threshold, llm_call, bot_user_id, mention_tracker)`
- 위치: 줄 266
...
### `async _handle_multi_judge(judge_result, store, channel_id, slack_client, cooldown, pending_messages, current_digest, debug_channel, intervention_threshold, llm_call, bot_user_id, session_manager, thread_buffers, mention_handled_ts)`
- 위치: 줄 485
- 설명: 복수 JudgeItem 처리: 이모지 일괄 + 개입 확률 판단

### `async _handle_single_judge(judge_result, store, channel_id, slack_client, cooldown, pending_messages, current_digest, debug_channel, intervention_threshold, llm_call, bot_user_id, session_manager, thread_buffers, mention_handled_ts)`
- 위치: 줄 606
- 설명: 하위호환: 단일 JudgeResult 처리

### `async _execute_intervene(store, channel_id, slack_client, action, pending_messages, observer_reason, llm_call, bot_user_id, session_manager, thread_buffers)`
- 위치: 줄 738
...
- `seosoyoung.slackbot.plugins.channel_observer.intervention.InterventionAction`
- `seosoyoung.slackbot.plugins.channel_observer.intervention.InterventionHistory`
- `seosoyoung.slackbot.plugins.channel_observer.intervention.burst_intervention_probability`
- `seosoyoung.slackbot.plugins.channel_observer.intervention.execute_interventions`
- `seosoyoung.slackbot.plugins.channel_observer.intervention.intervention_probability`
- `seosoyoung.slackbot.plugins.channel_observer.intervention.send_debug_log`
- `seosoyoung.slackbot.plugins.channel_observer.intervention.send_intervention_probability_debug_log`
- `seosoyoung.slackbot.plugins.channel_observer.intervention.send_multi_judge_debug_log`
- `seosoyoung.slackbot.plugins.channel_observer.observer.ChannelObserver`
- `seosoyoung.slackbot.plugins.channel_observer.observer.ChannelObserverResult`
- `seosoyoung.slackbot.plugins.channel_observer.observer.DigestCompressor`
- `seosoyoung.slackbot.plugins.channel_observer.observer.JudgeItem`
- `seosoyoung.slackbot.plugins.channel_observer.observer.JudgeResult`
- `seosoyoung.slackbot.plugins.channel_observer.prompts.build_channel_intervene_user_prompt`
- `seosoyoung.slackbot.plugins.channel_observer.prompts.get_channel_intervene_system_prompt`
