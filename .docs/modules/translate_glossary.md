# translate/glossary.py

> 경로: `seosoyoung/slackbot/plugins/translate/glossary.py`
...
### `_load_glossary_raw(glossary_path)`
- 위치: 줄 56
...
### `get_glossary_entries(glossary_path)`
- 위치: 줄 149
...
### `_get_kiwi(glossary_path)`
- 위치: 줄 186
- 설명: Kiwi 인스턴스 반환 (싱글톤, 사용자 사전 포함)

### `_extract_korean_words(text, glossary_path)`
- 위치: 줄 222
...
### `_build_word_index(glossary_path)`
- 위치: 줄 266
