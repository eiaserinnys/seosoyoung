...
- `original_thread_ts(self)` (줄 77): 세션의 원래 thread_ts
...
- `__init__(self, session_manager, session_runtime, restart_manager, send_long_message, send_restart_confirmation, update_message_fn)` (줄 89): 
