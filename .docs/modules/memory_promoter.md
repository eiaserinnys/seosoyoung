...
> 경로: `seosoyoung/slackbot/plugins/memory/promoter.py`
...
- `seosoyoung.slackbot.plugins.memory.prompts.build_compactor_prompt`
- `seosoyoung.slackbot.plugins.memory.prompts.build_promoter_prompt`
- `seosoyoung.slackbot.plugins.memory.store.generate_ltm_id`
