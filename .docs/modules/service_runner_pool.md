...
- `async _maintenance_loop(self)` (줄 330): 백그라운드 유지보수 루프
- `async start_maintenance(self)` (줄 347): 유지보수 루프 백그라운드 태스크 시작
- `async shutdown(self)` (줄 358): 모든 runner disconnect 및 유지보수 루프 취소
- `stats(self)` (줄 395): 현재 풀 상태 반환
