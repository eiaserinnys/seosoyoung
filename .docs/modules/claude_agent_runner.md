...
- `async _execute(self, prompt, session_id, on_progress, on_compact, user_id, thread_ts)` (줄 478): 실제 실행 로직 (ClaudeSDKClient 기반)
- `async compact_session(self, session_id)` (줄 676): 세션 컴팩트 처리
