...
- `format_as_blockquote()` (seosoyoung/slackbot/formatting.py:89): 텍스트를 슬랙 blockquote 형식으로 변환
- `build_trello_header()` (seosoyoung/slackbot/formatting.py:94): 트렐로 카드용 슬랙 메시지 헤더 생성
- `format_trello_progress()` (seosoyoung/slackbot/formatting.py:106): 트렐로 모드 채널 진행 상황 포맷
- `format_dm_progress()` (seosoyoung/slackbot/formatting.py:113): DM 스레드 진행 상황 포맷 (blockquote, 길이 제한)
- `format_initial_placeholder()` (seosoyoung/slackbot/formatting.py:123): 소울스트림 요청 전송 직후 표시할 대기 메시지
- `format_thinking_initial()` (seosoyoung/slackbot/formatting.py:128): thinking 메시지 초기 포맷
- `format_thinking_text()` (seosoyoung/slackbot/formatting.py:145): thinking 메시지 텍스트 갱신 포맷
- `format_thinking_complete()` (seosoyoung/slackbot/formatting.py:154): thinking 완료 포맷 — done 이모지로 교체한 최종 상태
- `format_tool_initial()` (seosoyoung/slackbot/formatting.py:192): tool 메시지 초기 포맷
- `format_tool_result()` (seosoyoung/slackbot/formatting.py:220): tool result 도착 시 표시 포맷
- `format_tool_complete()` (seosoyoung/slackbot/formatting.py:243): tool 메시지 완료 포맷 (결과 없이 이름만)
