...
- `RescueResult` (seosoyoung/rescue/runner.py:48): 실행 결과
- `RescueRunner` (seosoyoung/rescue/runner.py:57): Claude Code SDK 실행기 (공유 이벤트 루프 기반)
...
- `run_claude_sync()` (seosoyoung/rescue/runner.py:234): 모듈 레벨 래퍼 — main.py 호환용
