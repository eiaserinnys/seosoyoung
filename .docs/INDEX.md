...
- `register_mention_handlers()` (seosoyoung/slackbot/handlers/mention.py:464): 멘션 핸들러 등록
...
- `register_message_handlers()` (seosoyoung/slackbot/handlers/message.py:354): 메시지 핸들러 등록
