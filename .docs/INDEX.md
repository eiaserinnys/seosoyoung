...
- `ClaudeAgentRunner` (seosoyoung/claude/agent_runner.py:97): Claude Code SDK 기반 실행기
...
- `MemoryRecord` (seosoyoung/memory/store.py:29): 세션별 관찰 로그 레코드
- `MemoryStore` (seosoyoung/memory/store.py:84): 파일 기반 관찰 로그 저장소
...
- `async main()` (seosoyoung/claude/agent_runner.py:630): 
